...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background fixed inset-0 z-50 p-4">
      ...
      <FinanceCard className="w-full max-w-md p-8 z-10">
        {/* Logo */}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-4 bg-foreground/5 border border-border/50 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all"
                />
              </div>
            </div>
          )}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                minLength={6}
                className="w-full h-11 pl-10 pr-11 bg-foreground/5 border border-border/50 rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all"
              />
              <button
                type="button"
        ...
        {/* Data privacy note */}
        <p className="text-[11px] text-muted-foreground/50 mt-6 text-center leading-relaxed">
          Your data is stored locally in this browser. No data is sent to any server.
        </p>
      </FinanceCard>
    </div>
  );
