      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <motion.div variants={FADE_UP}>
          <FinanceCard className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Invested Assets</p>
            ...
            {investedAssets > 0 && (
              <div className="flex items-center gap-2 mt-4 text-xs">
                <span className={`font-medium px-1.5 py-0.5 rounded ${stockValue + mfValue - stockInvested - mfInvested >= 0 ? 'text-primary bg-primary/10' : 'text-destructive bg-destructive/10'}`}>
                  {((stockValue + mfValue - stockInvested - mfInvested) / (stockInvested + mfInvested) * 100).toFixed(1)}% Return
                </span>
              </div>
            )}
          </FinanceCard>
        ...
        <motion.div variants={FADE_UP}>
          <FinanceCard className="p-6">
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Liquid Cash</p>
