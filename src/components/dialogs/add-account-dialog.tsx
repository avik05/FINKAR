  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="bg-card border-border/50 backdrop-blur-2xl sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="font-heading text-xl">Add Bank Account</DialogTitle>
          <DialogDescription>Add a new bank account, card, or wallet to track.</DialogDescription>
        </DialogHeader>
